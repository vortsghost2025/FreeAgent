...
declare module '$env/static/private' {
	...
	export const LOCAL_MODEL_URL: string;
	export const EMBEDDINGS_URL: string;
	export const PREFER_LOCAL: string;
	...
	export const EFC_8444_344590478: string;
	...
	export const NEXT_OTEL_FETCH_DISABLED: string;
